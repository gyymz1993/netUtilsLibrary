...
import com.corelibs.encrypt.BaseData;
import com.corelibs.encrypt.EncryptBean;
import com.corelibs.encrypt.EncryptResponse;
import com.corelibs.encrypt.EncryptUtils;
...
public class ApiFactory {
    ...
    private Retrofit createRetrofit(String baseUrl) {
        ...
        clientBuilder.addInterceptor(new Interceptor() {
            ...
            public Response intercept(Chain chain) throws IOException {
                ...
                //获取不带RootUrl的请求参数
                String requestUrlWithOutRoot=requestBody.replace("{method=GET, url=","").replace(", tag=null}","").replace(Urls.ROOT,"");
                //请求的接口地址
                ...
                String reUrl=Urls.ROOT+Urls.GET;
                //发送加密后的参数
    ...
    private Response deEncryptResponse(Response response) throws IOException{
        ...
        //解密后的真实数据
        String responseRealData=EncryptUtils.decodeResponseToBean(new Gson().fromJson(oldBody, EncryptResponse.class));
        BaseData baseData=new Gson().fromJson(responseRealData,BaseData.class);
